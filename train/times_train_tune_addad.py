...
class Model_Development:
    def __init__(self, train_data, valid_data, test_data, classifier, model_path):
        ...
        self.output_dir = '/home/lijing/data/covid_19/other_model/redial-2020/redial-2020-notebook-work/reports_tuned_best_lijing'
        # self.output_models = '/home/lijing/data/covid_19/other_model/redial-2020/redial-2020-notebook-work/models_tuned_best_lijing_rs10'
        self.output_models = self.model_path
        ...
        self.model_file = os.path.join(self.output_models, f"{self.file_name2}_{classifier}.pkl")
    ...
    def load_params(self):
        ...
        with open('/home/lijing/data/covid_19/other_model/redial-2020/train/hyperparams.json', 'r') as hyp:
...
if __name__=='__main__':
    ...
    md = Model_Development(train, valid, test, classifier, model_path)
